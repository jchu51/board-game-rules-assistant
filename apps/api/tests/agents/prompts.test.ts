...
import { boardGameRuleMasterPrompt } from "../../src/infrastructure/agents/prompts/board-game-rule-master-prompt";
import { conversationTitlePrompt } from "../../src/infrastructure/agents/prompts/conversation-title-prompt";
import { ruleContextPrompt } from "../../src/infrastructure/agents/prompts/rule-context-prompt";
